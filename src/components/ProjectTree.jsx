...
const AVATAR_COLORS = ["#6366f1", "#f59e0b", "#10b981", "#3b82f6", "#ef4444", "#8b5cf6"];
...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span style={{ ...s, padding: "2px 10px", borderRadius: 999, fontSize: 12, fontWeight: 500, whiteSpace: "nowrap" }}>
      {status || "—"}
    </span>
  );
};
...
// ─── Timesheet ───────────────────────────────────────────────────────────────
// Fields: id, workDate, remarks, hoursWorked, approvalStatus
